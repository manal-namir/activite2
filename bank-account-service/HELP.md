...
* The original package name 'org.sid.bank-account-service' is invalid and this project uses 'org.sid.bankaccountservice' instead.
...
* [Spring for GraphQL](https://docs.spring.io/spring-boot/docs/$2.7.17/reference/htmlsingle/index.html#web.graphql)
